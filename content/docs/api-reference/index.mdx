...
<Cards>
  <Card title="Ingest record" href="/docs/api/ingest" description="Create or update content records for moderation" />

<Card title="Delete record" href="/docs/api/delete" description="Remove content records from the moderation system" />
